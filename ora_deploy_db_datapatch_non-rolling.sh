...
#                Process will shutdown databases to put in upgrade mode so will require downtime.
#
...
#				/u01/app/oracle/scripts/ora_deploy_db_datapatch_non-rolling.sh
#				or
#				/u01/app/oracle/scripts/ora_deploy_db_datapatch_non-rolling.sh <filename>
#######################################################################################################
#
################################################################
